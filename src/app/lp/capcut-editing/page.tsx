...
export default function CapCutLandingPage() {
  const highlights = [
    "Trim & pace audio to eliminate silences",
    "Dynamic subtitle overlays & kinetic caption styling",
    "Selecting keyframe visual animations & camera movements",
    "Applying high-impact sound design (ambient tracks & SFX)",
    "Color grading and export configurations for maximum quality"
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            <div className="inline-flex items-center gap-2 bg-brand-orange/15 text-brand-orange px-3.5 py-1 rounded-full text-xs font-bold uppercase tracking-wider">
              ...
              Video Editors Bootcamp
            </div>
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black text-brand-blue tracking-tight leading-tight">
              Master CapCut Mobile Video Editing. <br />
              <span className="text-brand-orange">Create Premium Reels & Shorts.</span>
            </h1>
            <p className="text-sm sm:text-base text-gray-500 leading-relaxed max-w-xl">
              Learn how to edit highly engaging visual content directly on your smartphone. Taught step-by-step in Telugu. Boost your editing speed by 3x.
            </p>
            ...
            <div className="border-t border-gray-200/60 pt-6 text-xs text-gray-400">
              Ideal for freelance video editors, Instagram creators, and beginners.
            </div>
          </div>

          {/* Inline Form */}
          <div className="lg:col-span-5 w-full">
            <LeadForm defaultCourse="CapCut Video Editing Course" isLandingPage={true} />
          </div>
