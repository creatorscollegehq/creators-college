...
export const metadata: Metadata = {
  ...
  description: "Learn content creation, video editing & social media growth in Telugu. 8-week hands-on course. 1,200+ students trained. Book your FREE demo class now!",
  keywords: [
  ...
  openGraph: {
    ...
    description: "Turn your phone into a ₹1L/month income machine. Learn from Creators College — 1,200+ trained students.",
