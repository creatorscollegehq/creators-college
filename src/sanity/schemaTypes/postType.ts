...
export const postType = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      title: 'Author Name',
      type: 'string',
      initialValue: 'Cecil Srungarapati',
      description: 'Enter who wrote the article. Defaults to Cecil Srungarapati so all articles link to the same author profile.',
      validation: (Rule) => Rule.required(),
      group: 'author',
    }),
    defineField({
      ...
      type: 'string',
      initialValue: 'Founder & CEO, Creators College',
      description: 'e.g. Founder & CEO, Creators College. Appears next to the author name.',
      validation: (Rule) => Rule.required(),
      group: 'author',
    }),
    defineField({
      ...
      type: 'url',
      initialValue: 'https://www.creatorscollege.in/cecil-srungarapati',
      description: 'Link the article author to an official profile page. Defaults to Cecil Srungarapati’s profile so every article connects to the same Person. Leave as-is unless a guest author needs a different profile URL.',
